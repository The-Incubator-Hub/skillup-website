...
const formSections: FormSection[] = [
  ...
  },
  {
    eyebrow: "Section 4",
    title: "Availability",
    description: "Tech Trybe Plus requires steady weekly commitment through the full learning pipeline.",
    fields: [
      {
  ...
  },
  {
    ...
    fields: [
      {
        name: "primaryGoal",
        label: "What is your primary goal for joining Tech Trybe Plus?",
        type: "select",
        required: true,
        options: [
...
export default function TechTrybePlusApplicationPage() {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch("/api/forms", {
        ...
        body: JSON.stringify({
          formType: "techTrybePlus",
          data: {
            programme: "Tech Trybe Plus",
            ...values,
          },
        }),
      });
          ...
          <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[minmax(0,1.12fr)_minmax(320px,0.88fr)] lg:items-center lg:px-8">
            <div>
              ...
              <p className="mt-6 max-w-2xl text-base leading-8 text-blue-50 md:text-lg">
                This form helps us confirm your readiness, preferred track, availability, and commitment for the Tech Trybe Plus programme.
              </p>
            </div>
            ...
            <aside className="h-fit rounded-lg border border-blue-100 bg-white p-5 shadow-sm lg:sticky lg:top-24">
              ...
              <div className="mt-6 grid gap-3 text-sm text-gray-700">
                ...
                <div className="flex items-center gap-2">
                  ...
                  Sent to the Tech Trybe Plus sheet
                </div>
              </div>
            </aside>
