...
export default function BootcampPage() {
  ...
  return (
    <div className="min-h-screen relative bg-white flex flex-col ">
      ...
      {/* Header */}
      <div className="border-b border-gray-200 px-4 pb-4 pt-[92px] sm:px-6">
