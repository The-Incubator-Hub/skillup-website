...
- Confirm PHP 8.3+, Composer, Node 22 LTS, database, queue worker, scheduler, SSL, and the PHP `intl` extension are installed. Filament admin tables will fail without `intl`.
...
- Webhooks: duplicate handling, failed webhook events, retries.
